...
<a class="btn cartbtn" href="/cart" title="Магазин"><i class="fas fa-shopping-basket fa-4x mb_cart"></i><div class="blocksummItem"><?=$_SESSION['quonty']?></div></a>
<a class="btn" href="/login" title="LogIn"><i class="fas fa-sign-in-alt fa-4x mb_cart"></i></a>
